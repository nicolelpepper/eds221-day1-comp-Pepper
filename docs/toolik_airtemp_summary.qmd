...
toolik_temp_plot <- ggplot(data = toolik_weather,
  ...
  scale_color_gradient(low = "#3F00FF", high = "#FF5733") +
  theme_minimal() +
...
ggplot(data = toolik_chlorophyll, 
     ...
     geom_point(aes(col = active_chl_a_ug_l),
                show.legend = FALSE) +
    scale_color_gradient(low = "orange", high = "#0e7965") +
                  theme_minimal() +
  labs (title = "Toolik Chlorophyll", x = "Lake Depth (meters)", y = "Active Chlorophyll Concentration (micrograms per liter")
